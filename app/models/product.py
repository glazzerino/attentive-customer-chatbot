...
class Product:
    ...
    @classmethod
    async def create(cls, name: str, description: str, price: float, image_url: Optional[str] = None, categories: Optional[List[str]] = None) -> 'Product':
    ...
    @classmethod
    async def search(cls, query: str, category: Optional[str] = None, limit: int = 10) -> List['Product']:
